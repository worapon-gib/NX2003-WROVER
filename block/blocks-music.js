...
module.exports = function (Blockly) {
	...
	Blockly.Blocks['music_song_ice_cream'] = {
		init: function () {
			this.appendDummyInput()
				.appendField("ice cream")
			let f = new Blockly.FieldTextInput("B4,D5,A4,E5,G5,C5,E5,F#5,D5,E5,F#5,A5,G5");
	...
	Blockly.Blocks['music_cat'] = {
		init: function () {
			...
			this.setNextStatement(true, null);
			this.setColour(165);
			this.setTooltip("noo malee : tempo is 240");
			this.setHelpUrl("");
		}
	};
	Blockly.Blocks['music_conan'] = {
		init: function () {
			...
			this.setNextStatement(true, null);
			this.setColour(165);
			this.setTooltip("conan music : tempo is 145");
			this.setHelpUrl("");
		}
	};
	Blockly.Blocks['music_mario'] = {
		init: function () {
			...
			this.setNextStatement(true, null);
			this.setColour(165);
			this.setTooltip("mario music : tempo is 240");
			this.setHelpUrl("");
		}
	};
